...
fighter_image = pygame.image.load('images/fighter.jpg')
FIGHTER_STEP = 0.2
...
game_score = 0
game_score_for_speed_increase = 0
...
while game_is_running:
    ...
    if fighter_is_moving_left and fighter_x >= FIGHTER_STEP >= FIGHTER_STEP:
    ...
    if ball_was_fired and \
        ...
        alien_x, alien_y = randint(0, screen_width - alien_width), 0
        game_score += 1
        game_score_for_speed_increase += 1
        if game_score_for_speed_increase == 5:
